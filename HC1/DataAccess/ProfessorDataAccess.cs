...
namespace PrviProjektniZadatakHCI.DataAccess
{
    class ProfessorDataAccess
    {
        ...
        public static Profesor GetProfesor(int idKorisnika)
        {
            ...
            WHERE k.Username = @idKorisnika";
                commandKorisnik.Parameters.AddWithValue("@idKorisnika", idKorisnika);
